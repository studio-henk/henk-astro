export default{props:{buttonType:{type:String,default:"button",required:true},buttonId:{type:String,default:"button",required:true},buttonText:{type:String,default:"button text"},modalMaxWidth:{type:String,default:"200px"},overlayOpacity:{type:String,default:"0.3"},hideOnDevice:{type:String,default:""}},data(){return{show:false}},methods:{onShow(){document.querySelector("body").style.overflow="hidden"},onHide(){document.querySelector("body").style.removeProperty("overflow");if(document.querySelector("body").style.length===0){document.querySelector("body").removeAttribute("style")}}},template:`
