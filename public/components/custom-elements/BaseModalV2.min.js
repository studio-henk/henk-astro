class BaseModalV2 extends HTMLElement{static get observedAttributes(){return["open","openButtonText","modalTitle"]}constructor(){super();this.shadow=this.attachShadow({mode:"open"})}generateTemplate(){const openButtonText=this.getAttribute("openButtonText")||"Open";const modalTitle=this.getAttribute("modalTitle")||"Modal title";return`      
    <style>
    :host {
