...
/*!
 * Generated using the Bootstrap Customizer (https://getbootstrap.com/docs/3.3/customize/?id=abf3e269d1fc392b0d2bb04f5826916d)
 * Config saved to config.json and https://gist.github.com/abf3e269d1fc392b0d2bb04f5826916d
 */
...
+function ($) {
  ...
  $(document).on('click.bs.modal.data-api', '[data-bstoggle="modal"]', function (e) {
    var $this   = $(this)
    var href    = $this.attr('href')
    var $target = $($this.attr('data-bstarget') || (href && href.replace(/.*(?=#[^\s]+$)/, ''))) // strip for ie7
