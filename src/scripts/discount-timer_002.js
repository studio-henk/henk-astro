...
/*const countDownDate = new Date("Oct 10, 2023 16:53:0").getTime();*/
...
let x = setInterval(function () {
    ...
    if (distance > 0) {
        ...
        // document.getElementById("msg-covid").querySelector("a:first-child").style.display = "none";
    }
    ...
    if (distance < 0) {
        ...
        // document.getElementById("msg-covid").querySelector(".sh-org-msg-bar__discount-link").style.display = "none";
        // console.log()
    }
}, 1000);